# AGENTS.md — Hinweise für KI-Agenten (gregMod.CableTracer)

Repo: [https://github.com/mleem97/gregMod.CableTracer](https://github.com/mleem97/gregMod.CableTracer) · Lizenz: Apache-2.0 · Version: siehe `VERSION`.
